...
export const ColorPickerDropdown: React.FC<ColorPickerDropdownProps> = ({
  ...
  return (
    <Popover placement="bottom">
      <PopoverTrigger>
        <Button variant="bordered" className={cn("justify-between", className)}>
          {label}
          <div
            className="h-5 w-10 translate-x-1.5 justify-self-end rounded-md"
            style={{ backgroundColor: value }}
          />
        </Button>
      </PopoverTrigger>
      <PopoverContent className="p-1.5">
        <div className="max-h-52 overflow-y-auto rounded-xl p-1">
