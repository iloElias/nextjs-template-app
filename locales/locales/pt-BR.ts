export default {
  metadata: {
    ...
    login: {
      title: "Login",
      description: "Entre na sua conta para acessar seus recursos.",
    },
    register: {
      title: "Criar Conta",
    ...
    "privacy-policy": {
      ...
      description:
        "Leia nossa política de privacidade para entender como tratamos seus dados.",
    },
    "terms-of-service": {
      title: "Termos de Serviço",
      description:
        "Leia nossos termos de serviço antes de usar nossa plataforma.",
    },
  },
  "mdx-editor": {
    frontmatterEditor: {
  ...
  auth: {
    ...
    register: {
      title: "Criar conta",
      subtitle: "Junte-se a nós e comece agora",
      name: "Nome Completo",
      ...
      submit: "Criar Conta",
      googleRegister: "Cadastrar com o Google",
      divider: "ou",
  ...
  legal: {
    "privacy-policy": {
      title: "Política de Privacidade",
      lastUpdated: "Última atualização: 10 de maio de 2026",
    },
    "terms-of-service": {
      title: "Termos de Serviço",
      lastUpdated: "Última atualização: 10 de maio de 2026",
  ...
  "markdown-pdf": {
    ...
    description:
      "Exporte seu documento markdown como PDF versionado no servidor",
    preview: "Pré-visualização",
    exportToServer: "Exportar para o Servidor",
    exporting: "Exportando...",
    exportSuccess: "PDF exportado e salvo com sucesso",
    exportError: "Falha na exportação. Tente novamente.",
    downloadPdf: "Baixar PDF",
    openPdf: "Abrir PDF",
    copyLink: "Copiar link de pré-visualização",
    linkCopied: "Link copiado!",
    versionsTitle: "Histórico de Versões",
    noVersions: "Nenhuma versão exportada ainda",
    version: "v{n}",
    fileSize: "{size}",
    exportedAt: "{date}",
    deleteVersion: "Excluir versão",
    confirmDeleteVersion:
      "Tem certeza que deseja excluir esta versão do PDF? Esta ação não pode ser desfeita.",
    noContent: "Nenhum conteúdo markdown fornecido",
    noContentDescription: "Adicione ?content=<base64> ou ?project=<uuid> à URL",
    contentSource: "Origem",
    contentSourceUrl: "Parâmetro da URL",
    contentSourceProject: "Projeto local",
    loadError: "Falha ao carregar o conteúdo",
